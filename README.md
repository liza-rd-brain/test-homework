## Комментарии к дз:
* Интеграциоными тестами не удалось ловить баги. Их выпилила, оставила только  e2e. 
* Для e2e использовала playwright.
* node: v16.20.1
* Рекомендую проверять в режиме браузера инкогнито. Инача баг может не воспроизвестить из-за кеширования.
